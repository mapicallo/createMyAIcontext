...
export const es: Messages = {
  ...
  errorEmptyFile: 'No hay texto extraíble (PDF escaneado/imagen necesita OCR — prueba TXT/MD o pega el texto).',
  errorPdf: 'No se pudo leer este PDF. Prueba otra exportación o pega el texto.',
